...
var ChartTooltipContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", { ref: ref, className: (0, utils_1.cn)("grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-gray-200 border-gray-200/50 bg-white px-2.5 py-1.5 text-xs shadow-xl dark:border-gray-800 dark:border-gray-800/50 dark:bg-gray-950", className) },
        ...
        React.createElement("div", { className: "grid gap-1.5" }, payload.map(function (item, index) {
            ...
            return (React.createElement("div", { key: item.dataKey, className: (0, utils_1.cn)("flex w-full flex-wrap items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-gray-500 dark:[&>svg]:text-gray-400", indicator === "dot" && "items-center") }, formatter && (item === null || item === void 0 ? void 0 : item.value) !== undefined && item.name ? (formatter(item.value, item.name, item, index, item.payload)) : (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: (0, utils_1.cn)("flex flex-1 justify-between leading-none", nestLabel ? "items-end" : "items-center") },
                    React.createElement("div", { className: "grid gap-1.5" },
                        nestLabel ? tooltipLabel : null,
                        React.createElement("span", { className: "text-gray-500 dark:text-gray-400" }, (itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.label) || item.name)),
                    item.value && (React.createElement("span", { className: "font-mono font-medium tabular-nums text-gray-950 dark:text-gray-50" }, item.value.toLocaleString())))))));
        }))));
});
...
var ChartLegendContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", { ref: ref, className: (0, utils_1.cn)("flex items-center justify-center gap-4", verticalAlign === "top" ? "pb-3" : "pt-3", className) }, payload.map(function (item) {
        var key = "".concat(nameKey || item.dataKey || "value");
        var itemConfig = getPayloadConfigFromPayload(config, item, key);
        return (React.createElement("div", { key: item.value, className: (0, utils_1.cn)("flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-gray-500 dark:[&>svg]:text-gray-400") },
