...
var Card = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref, className: (0, utils_1.cn)("rounded-lg border border-gray-200 bg-white text-gray-950 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50", className) }, props)));
});
exports.Card = Card;
...
var CardTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, className: (0, utils_1.cn)("text-2xl font-semibold leading-none tracking-tight", className) }, props)));
});
exports.CardTitle = CardTitle;
CardTitle.displayName = "CardTitle";
var CardDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, className: (0, utils_1.cn)("text-sm text-gray-500 dark:text-gray-400", className) }, props)));
});
